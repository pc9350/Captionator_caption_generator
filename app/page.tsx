...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-950">
        ...
        <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left space-y-8">
              <div className="inline-block px-4 py-1 bg-indigo-100 dark:bg-indigo-900/50 rounded-full text-indigo-800 dark:text-indigo-300 font-medium text-sm mb-2 animate-pulse">
                AI-Powered Caption Generator
              </div>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 leading-tight pb-2">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <Link
                  href="/dashboard"
                  className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl font-medium transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-lg"
                >
                  Get Started Free
                </Link>
                <Link
                  href="#features"
                  className="px-8 py-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-900 dark:text-white rounded-xl font-medium hover:bg-white dark:hover:bg-gray-700 transition-all duration-300 text-center flex items-center justify-center shadow-lg text-lg group"
                >
                  Explore Features
            ...
            <div className="relative mx-auto max-w-lg lg:max-w-none">
              <div className="relative z-10 flex justify-center">
                ...
                <div 
                  className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl transform hover:rotate-1 transition-transform cursor-pointer max-w-sm mx-auto border border-gray-100 dark:border-gray-700"
                >
                  <div className="p-5">
                    <div className="flex items-center mb-4">
                      <div className="h-10 w-10 rounded-full bg-gradient-to-br from-purple-400 to-pink-500 flex items-center justify-center text-white font-bold">T</div>
                      <div className="ml-3">
                        <div className="font-semibold text-gray-900 dark:text-white">travel_enthusiast</div>
                        <div className="text-sm text-gray-500">Cappadocia, Turkey</div>
                      </div>
                    </div>
                    <div className="relative pb-[100%] rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700">
                      <Image
                    ...
                    <div className="mt-4">
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        <button 
                          className="text-2xl text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
                        ...
                        <button 
                          className="text-2xl text-gray-700 dark:text-gray-300 hover:text-green-500 dark:hover:text-green-400 transition-colors"
                      ...
                      <div className="space-y-2">
                        <p className="text-gray-900 dark:text-white">
                          <span className="font-semibold">@travel_enthusiast</span> <span className="text-lg">Floating above the world in a kaleidoscope of colors. Cappadocia's magical landscapes have stolen my heart forever. ✨🎈 #TravelGoals #Cappadocia #BucketList</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3">
                    ...
                    <div className="mt-3">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <button 
                          className="text-xl text-gray-700 dark:text-gray-300 hover:text-green-500 dark:hover:text-green-400 transition-colors"
                          aria-label="Share post"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"></path>
                      ...
                      <div className="text-sm font-semibold text-gray-900 dark:text-white mb-1">567 likes</div>
