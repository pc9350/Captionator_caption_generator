...
import { FiSettings, FiSliders, FiGrid } from 'react-icons/fi';

export default function Dashboard() {
  const { isSignedIn, user, isLoaded } = useUser();
  const [showOptions, setShowOptions] = useState(true); // Default to showing options
  const [selectedTone, setSelectedTone] = useState('casual');
  const [activeTab, setActiveTab] = useState('tones'); // 'tones' or 'options'
